...
1.  Sign up for a **personal** GitHub account at <https://github.com/signup> using any email address you can access (your school email, QQ mail, Gmail — anything works).
...
(R6) We have a resistor RMCF0603FT2K20 and the [RMCF/RMCP Series datasheet](https://www.seielect.com/catalog/sei-rmcf_rmcp.pdf). What is the power rating for our resistor at 70˚C?
...
3.  **Email** the PDF to the teaching team at [**teaching-team-email@example.com**](mailto:teaching-team-email@example.com) (the real address will be confirmed by your instructor) with the subject line:
